...
public class UserController {
  ...
  @GetMapping("/{id}")
  @PreAuthorize("hasRole('ADMIN') or @userPermissionEvaluator.isSameUser(authentication.principal, #id)")
  ...
  @PutMapping("/{id}")
  @PreAuthorize("hasRole('ADMIN') or (@userPermissionEvaluator.isSameUser(authentication.principal, #id) && hasAuthority('USER_MODIFY'))")
  ...
  @DeleteMapping("/{id}")
  @PreAuthorize("hasRole('ADMIN') or (@userPermissionEvaluator.isSameUser(authentication.principal, #id) && hasAuthority('USER_DEACTIVATE'))")
